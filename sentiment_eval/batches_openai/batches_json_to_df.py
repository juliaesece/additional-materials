    ...
    with open(file_path, 'r') as file:
        for line in file:
            try:
                ...
                data.append({'custom_id': custom_id, 'message_content': message_content})
...
print(f"Total rows in DataFrame: {len(result_df)}")

# Save the DataFrame to a CSV file
result_df.to_csv('batch_all_climate_output.csv', index=False)